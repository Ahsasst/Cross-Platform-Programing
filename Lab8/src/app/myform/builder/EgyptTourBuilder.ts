...
export class EgyptTourBuilder implements IBuilder {
   type_tour!: TourType;
   name_tour: string = "";
   details_tour: string = "";
   ...
   getResult(): EgyptTour {
      return new EgyptTour(this.name_tour, this.details_tour, this.date_departure, this.date_return, this.price_tour);
   }
}