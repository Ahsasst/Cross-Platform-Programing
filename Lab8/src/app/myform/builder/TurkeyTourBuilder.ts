...
export class TurkeyTourBuilder implements IBuilder {
   type_tour!: TourType;
   name_tour: string = "";
   details_tour: string = "";
   ...
   getResult(): TurkeyTour {
      return new TurkeyTour(this.name_tour, this.details_tour, this.date_departure, this.date_return, this.price_tour);
   }
}